...
public class CommentAnswer {
	...
	private Long date = null;         // Javascript timestamp of when comment answer was written.
	private String answer = null;	   // The text contents of the comment answer.
	private Long id = null;            // A random ID for the comment answer that is unique within the document.
	//
